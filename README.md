...
You can download the latest release for windows: https://github.com/MatthewInch/UI24RBridge/releases/download/v0.6.7/win-x86-core.zip


for Linux: https://github.com/MatthewInch/UI24RBridge/releases/download/v0.6.7/linux-x64.zip
